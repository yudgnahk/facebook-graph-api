...
const (
	...
	GetConversationsEndpoint = "%v/conversations?fields=message_count,participants,unread_count,messages.limit(1){created_time,message,sticker,attachments{image_data,video_data,file_url},from,id}"
